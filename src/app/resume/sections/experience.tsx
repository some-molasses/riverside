    ...
    <section id="experience-section">
      ...
      >
        <li>
          ...
          <HL terms="database">DynamoDB</HL> and <HL terms="database">Redis</HL>{" "}
          to process up to{" "}
          <HL terms="database">1.8 M real-time search update records daily</HL>
        </li>
        <li>
        ...
        <li>
          Implemented and monitored <HL terms="quality">metrics dashboards</HL>{" "}
          through <HL terms="quality">Datadog</HL> to ensure services operated
          at target levels
        </li>
      </ExperienceItem>
      <ExperienceItem
      ...
      >
        ...
        <li>
          ...
          <HL terms="a11y">WCAG 2.1 accessibility features</HL>, drawing praise
          from external teams
        </li>
        <li>
      ...
      >
        <li>
          ...
          endpoints and complex <HL terms="database">SQL</HL> stored procedures
          to support frontend specifications
        </li>
        <li>
          Developed <HL terms="frontend javascript">new frontend interfaces</HL>{" "}
          using ExtJS to support design specifications and display API data.
        </li>
      </ExperienceItem>
      <ExperienceItem
        name="Web Developer"
      ...
      >
        <li>
          ...
          <HL terms="frontend html">HTML</HL>, <HL terms="frontend css">CSS</HL>
