  ...
  return (
    <section id="projects-section">
      ...
      <Project name="better-walks" date="2024">
        <li>
          Designed and developed a <HL terms="frontend">React Native</HL> mobile
          app to navigate users through real-world scavenger hunts
        </li>
        <li>
          Built a map node <HL terms="search backend">retrieval pipeline</HL> to
          identify, rank, process, and retrieve locations of interest
        </li>
        <li>
          Integrated OpenStreetMap datasets using the Overpass and
          OpenRouteService APIs to source <HL terms="backend gis">GIS data</HL>
        </li>
      </Project>
      <Project name="MathSoc Website" date="2024">
        <li>
          <HL terms="project">Led teams of software developers</HL> to redevelop
          the website of the University of Waterloo Undergraduate Society of
          Mathematics
        </li>
        <li>
