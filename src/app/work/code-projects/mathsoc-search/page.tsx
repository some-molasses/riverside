...
export default function MathsocSearch() {
  return (
    <PageContents id="mathsoc-search">
      <Content>
        <Titles title={"MathSoc Search Engine"} />

        <ServerSideMarkdown src="src/app/work/code-projects/mathsoc-search/description.md" />
